# -*- coding: utf-8 -*-
"""
Created on Mon Dec 13 10:58:31 2021
        ...
        for i in range(self.episode_num):
            ...
            while True:
                ...
                if done==True:
                    ...
                    action_best=self.q[s_].index(max(self.q[s_]))
                    td_error=reward+self.discount*self.q[s_][action_best]-self.q[state][action]
                    for state in E.keys():
                        for action in range(4):
                            self.q[state][action]+=self.alpha*td_error*E[state][action]
                            if action_==action_best:
